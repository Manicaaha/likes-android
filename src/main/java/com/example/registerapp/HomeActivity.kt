...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val addintent: Button = findViewById(R.id.home_button_add)
        val postsintent: Button = findViewById(R.id.home_button_posts)

        val db = Firebase.firestore

        addintent.setOnClickListener {
            val addPostIntent = Intent(this, AddPostsActivity::class.java)
            startActivity(addPostIntent)
        }
        postsintent.setOnClickListener {
